...
from ejemplo.views import (AltaAlumno, AltaDocente, BorrarFamiliar, index, mostrar_familiares, BuscarFamiliar, AltaFamiliar, ActualizarFamiliar, mostrar_alumnos , BuscarAlumno)
